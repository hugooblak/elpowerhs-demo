...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'elpowerhs-leads' ),
				'storm'       => __( 'Storm or hail damage', 'elpowerhs-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'elpowerhs-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'elpowerhs-leads' ),
				'not-sure'    => __( 'Vet inte än', 'elpowerhs-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'elpowerhs-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'elpowerhs-leads' ),
				'research' => __( 'Jag kollar bara priser', 'elpowerhs-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'elpowerhs-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'elpowerhs-leads' ),
		'contacted' => __( 'Kontaktad', 'elpowerhs-leads' ),
		'quoted'    => __( 'Quote sent', 'elpowerhs-leads' ),
		'won'       => __( 'Won', 'elpowerhs-leads' ),
		'lost'      => __( 'Lost', 'elpowerhs-leads' ),
		'spam'      => __( 'Misstänkt spam', 'elpowerhs-leads' ),
	);
}
